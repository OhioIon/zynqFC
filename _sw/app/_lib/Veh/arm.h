...
typedef struct arm_inp_s
{
  ...
  int16_t yaw_perml_s16; // Yaw channel value [‰]
  int16_t pit_perml_s16; // Pitch channel value [‰]
  int16_t rol_perml_s16; // Roll channel value [‰]
  int16_t thr_perml_s16; // Throttle channel value [‰]

}arm_inp_ts;

typedef struct arm_prm_s
{
  int16_t yawThres_perml_s16; // Yaw threshold value [‰]
  int16_t pitThres_perml_s16; // Pitch threshold value [‰]
  int16_t rolThres_perml_s16; // Roll threshold value [‰]
...
typedef struct arm_prv_s
{
  ...
  uint32_t cntArmed_us_u32; // Armed debounce timer [µs]
