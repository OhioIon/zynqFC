...
#
# zynqAIO.xpr.tcl: Tcl script for re-creating project 'zynqAIO'
#
# Generated by Vivado on Thu Jul 11 23:31:01 +0200 2019
...
#
# 1. This project restoration tcl script (zynqAIO.xpr.tcl) that was generated.
#
...
set script_file "zynqAIO.xpr.tcl"
...
proc cr_bd_main { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_33_DIRECTION {in} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#SPI 1#SPI 1#SPI 1#SPI 1#GPIO#GPIO#SPI 0#SPI 0#SPI 0#SPI 0#GPIO#SPI 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#I2C 1#I2C 1#GPIO#GPIO#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#mosi#miso#sclk#ss[0]#gpio[14]#gpio[15]#sclk#miso#ss[0]#ss[1]#gpio[20]#mosi#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#scl#sda#gpio[30]#gpio[31]#tx#rx#gpio[34]#gpio[35]#gpio[36]#gpio[37]#gpio[38]#gpio[39]#clk#cmd#data[0]#data[1]#data[2]#data[3]#gpio[46]#gpio[47]#gpio[48]#gpio[49]#gpio[50]#gpio[51]#gpio[52]#gpio[53]} \
   ...
   CONFIG.PCW_UART1_UART1_IO {MIO 32 .. 33} \
