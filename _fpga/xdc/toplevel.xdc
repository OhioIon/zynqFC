# DShot
set_property PACKAGE_PIN N15 [get_ports dshot_0]
set_property PACKAGE_PIN L14 [get_ports dshot_1]
set_property PACKAGE_PIN K16 [get_ports dshot_2]
set_property PACKAGE_PIN K14 [get_ports dshot_3]
...
# IIC IMU
set_property PACKAGE_PIN W20 [get_ports iic_imu_scl]
set_property PACKAGE_PIN V20 [get_ports iic_imu_sda]
